...
function wrpc.new_peer(channel_name, service, conn)
  local peer = channels[channel_name] or setmetatable({
    seq = 1,
  ...
  peer.service = service or peer.service
  peer.conn = conn or peer.conn
